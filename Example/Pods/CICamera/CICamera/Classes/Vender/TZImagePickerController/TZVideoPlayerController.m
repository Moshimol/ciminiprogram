...
- (void)configPlayButton {
    ...
    [_playButton setImage:[UIImage tz_imageNamedFromMyBundle:@"MMVideoPreviewPlay_tz"] forState:UIControlStateNormal];
    [_playButton setImage:[UIImage tz_imageNamedFromMyBundle:@"MMVideoPreviewPlayHL_tz"] forState:UIControlStateHighlighted];
...
- (void)viewDidLayoutSubviews {
    ...
    _toolBar.frame = CGRectMake(0, self.view.tz_height - toolBarHeight, SCREENWIDTH, toolBarHeight);
    _doneButton.frame = CGRectMake(SCREENWIDTH - 44 - 12, 0, 44, 44);
    _playButton.frame = CGRectMake(0, statusBarAndNaviBarHeight, SCREENWIDTH, self.view.tz_height - statusBarAndNaviBarHeight - toolBarHeight);
