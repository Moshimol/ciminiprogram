...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if (_currentIndex) {
        [_collectionView setContentOffset:CGPointMake((SCREENWIDTH + 20) * self.currentIndex, 0) animated:NO];
    }
...
- (void)configCustomNaviBar {
    ...
    [_backButton setImage:[UIImage tz_imageNamedFromMyBundle:@"navi_back_tz"] forState:UIControlStateNormal];
...
- (void)configCollectionView {
    ...
    _collectionView.contentSize = CGSizeMake(self.models.count * (SCREENWIDTH + 20), 0);
...
- (void)viewDidLayoutSubviews {
    ...
    _naviBar.frame = CGRectMake(0, 0, SCREENWIDTH, naviBarHeight);
    _backButton.frame = CGRectMake(10, 10 + statusBarHeightInterval, 44, 44);
    _selectButton.frame = CGRectMake(SCREENWIDTH - 56, 10 + statusBarHeightInterval, 44, 44);
    _indexLabel.frame = _selectButton.frame;
    
    _layout.itemSize = CGSizeMake(SCREENWIDTH + 20, self.view.tz_height);
    _layout.minimumInteritemSpacing = 0;
    _layout.minimumLineSpacing = 0;
    _collectionView.frame = CGRectMake(-10, 0, SCREENWIDTH + 20, self.view.tz_height);
    ...
    _toolBar.frame = CGRectMake(0, toolBarTop, SCREENWIDTH, toolBarHeight);
    if (_tzImagePickerVc.allowPickingOriginalPhoto) {
    ...
    _doneButton.frame = CGRectMake(SCREENWIDTH - _doneButton.tz_width - 12, 0, _doneButton.tz_width, 44);
